...
import com.example.esjumbo_122.ui.theme.komponen.FormatLabelHarga
...
fun HalamanDua (
    ...
    val items = listOf(
        ...
        Pair(stringResource(id = R.string.phone), orderUIState.telpon),
        Pair(stringResource(id = R.string.address), orderUIState.alamat),
